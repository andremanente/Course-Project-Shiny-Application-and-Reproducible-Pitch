...
The application is running on (https://andremanente.shinyapps.io/Course-Project-Shiny-Application-and-Reproducible-Pitch/)

ui.R, and Server.R Code in my github repository (https://github.com/andremanente/Course-Project-Shiny-Application-and-Reproducible-Pitch)
